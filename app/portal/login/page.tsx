      ...
      <div style={{ width: 420, padding: 28, borderRadius: 10, boxShadow: '0 8px 24px rgba(0,0,0,0.06)', background: '#fff', color: '#000' }}>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 6 }}>
            ...
            <button type="button" onClick={() => { setEmail(''); setPassword(''); setMsg(''); setError(null); }} style={{ padding: '10px 14px', borderRadius: 8, border: '1px solid #e6e6e6', background: '#fff', color: '#000' }}>Clear</button>
          </div>
        </form>
